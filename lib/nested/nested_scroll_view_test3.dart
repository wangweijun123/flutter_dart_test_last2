...
class NestedScrollViewExampleApp3 extends StatelessWidget {
  const NestedScrollViewExampleApp3({super.key});

  @override
  Widget build(BuildContext context) {
    return const MaterialApp(
      home: NestedScrollViewExample3(),
    );
  }
}

class NestedScrollViewExample3 extends StatelessWidget {
  const NestedScrollViewExample3({super.key});
