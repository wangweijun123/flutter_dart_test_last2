...
class WheelPainter2 extends CustomPainter {
  late List<double> _list;
  late List<Color> _listColor;
  double _total = 0; //总份数

  WheelPainter2(this._list, this._listColor);
...
//将饼图包装成一个新的控件
class Cake2 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    // 自定义画笔 CustomPaint
    return CustomPaint(
      size: Size(200, 200),
      painter: WheelPainter2([10.0, 20.0], [Colors.red, Colors.black]),
    );
  }
}
